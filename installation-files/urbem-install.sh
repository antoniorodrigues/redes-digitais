...
#### Script de instalalacao do urbem 2.03.9 - Ubuntu 12.04 ###
...
### Instalacao e configuracao do apache e postgresql ###
...
### Download e instalacao do urbem ###

sudo wget www.urbem.cnm.org.br/downloads/urbem_2.03.9.sql.bz2

sudo bunzip2 urbem_2.03.9.sql.bz2
sudo -u postgres psql urbem < urbem_2.03.9.sql
...
wget http://www.urbem.cnm.org.br/versao/03032015-urbem_2.03.9.tar.bz2 -O 03032015-urbem_2.03.9.tar.bz2

tar xjf 03032015-urbem_2.03.9.tar.bz2
