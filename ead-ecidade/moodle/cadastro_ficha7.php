        ...
        <div class="span8">
            ...
            <div class="content-curso"> <!-- MODIFICAR CONTEÚDO AQUI -->
                ...
                <div class="text-content"> 
					<p>Para excluir um tipo de ficha no e-Cidade, é necessário selecioná-lo em uma tela semelhante a da figura, que o sistema já disponibiliza como resultado de uma pesquisa de todas os tipos de ficha cadastrados no sistema.</p>
					<br>

					<div class="mtlsr-images-for-lightbox">
						<a href="e-Cidade-EAD--master/images/selecao_exclusao_ficha_amp.png"> <!-- Imagem ampliada -->
                    ...
                    <div class="row-fluid navegacao short">
                        ...
                        <div class="previous">
                            ...
                            <a href="cadastro_ficha6.php">ANTERIOR</a>
                            <br>
                            <h4 style="margin-left: 40px;">Acesso a Exclusão do Tipo de Ficha</h4>
                        </div>

                        <div class="proximo">
                            <img class="seta" src="e-Cidade-EAD--master/assets/ic_seta_direita.png">
                            <a href="cadastro_ficha8.php">PRÓXIMO</a>
                            <br>
                            <h4 style="float: right; ">Exclusão do Tipo de Ficha</h4>
                        </div>
