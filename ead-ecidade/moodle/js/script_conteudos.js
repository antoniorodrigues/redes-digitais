...
if (h_size <= 200) { h_size = "600";}
 $('body', $('iframe#conteudo').contents()).css({ 'margin-left': '-100px', 'margin-top':'80px', 'width': '1200px', 'overflow-y': 'scroll', 'overflow-x': 'hidden'});
$('iframe#conteudo').css({'position': 'initial',  'width': '800px', 'height': (h_size+"px"), 'overflow-x': 'hidden'});
