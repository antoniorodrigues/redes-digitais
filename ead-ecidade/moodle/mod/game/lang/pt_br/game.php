...
/**
 * Strings for component 'game', language 'pt_br', branch 'MOODLE_20_STABLE'
 *
 * @package   game
...
$string['bookquiz_layout0'] = 'Pergunta no topo do livro';
$string['bookquiz_layout1'] = 'Pergunta na base inferior do livro';
